package com.redsystem.agendaonline.IA;
...
public class Reconocimiento_de_Texto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReconocerTexto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (uri == null){
                    Toast.makeText(Reconocimiento_de_Texto.this, "Por favor seleccione una imagen", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void reconocerTextoDeImagen() {
        if (uri == null) {
            ...
            try {
                ...
                imagen.setImageURI(uri); // Mostrar la imagen en el ImageView antes de reconocer el texto
                ...
                Task<Text> textTask = textRecognizer.process(inputImage)
                        .addOnSuccessListener(new OnSuccessListener<Text>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                progressDialog.dismiss();
                                Toast.makeText(Reconocimiento_de_Texto.this, "No se pudo reconocer el texto debido a: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            } catch (IOException e) {
                progressDialog.dismiss();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(Reconocimiento_de_Texto.this, "Cancelado por el usuario", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_ia, menu);
